                    ...
                    <div class="Form">
                        <form action="./validation.php" method="post">
                            ...
                            <div class="contact_elem-group">
                                ...
                                <select class="contact_select" id="department-selection" name="concerned_department" required>
                            ...
                            <div class="contact_elem-group">
                                <label class="contact_label" for="title">Reason For Contacting Us</label>
                                <input class="contact_input" type="text" id="title" name="email_title" required placeholder="Unable to Reset my Password" pattern=[A-Za-z0-9\s]{8,60}>
                            </div>
                            <div class="contact_elem-group">
                                <label class="contact_label" for="message">Write your message</label>
                                <textarea class= "contact_textarea" id="message" name="visitor_message" placeholder="Say whatever you want." required></textarea>
                            </div>
