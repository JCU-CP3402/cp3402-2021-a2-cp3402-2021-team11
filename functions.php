<?php
/**
 * CMSAssignmentTheme functions and definitions
 *
...
if ( ! function_exists( 'cmsassignmenttheme_setup' ) ) :
	/**
	 ...
	 */
	function cmsassignmenttheme_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on CMSAssignmentTheme, use a find and replace
		 * to change 'cmsassignmenttheme' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'cmsassignmenttheme', get_template_directory() . '/languages' );
		...
		register_nav_menus(
			array(
				'menu-1' => esc_html__( 'Primary', 'cmsassignmenttheme' ),
			)
		);
		...
		add_theme_support(
			'custom-background',
			apply_filters(
				'cmsassignmenttheme_custom_background_args',
				array(
...
add_action( 'after_setup_theme', 'cmsassignmenttheme_setup' );
 ...
 */
function cmsassignmenttheme_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'cmsassignmenttheme_content_width', 640 );
}
add_action( 'after_setup_theme', 'cmsassignmenttheme_content_width', 0 );
 ...
 */
function cmsassignmenttheme_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'cmsassignmenttheme' ),
			'id'            => 'sidebar-1',
...
add_action( 'wp_enqueue_scripts', 'cmsassignmenttheme_scripts' );
